    ...
    return (
        <article
            ...
            <div className={"px-0 md:px-10"}>
                <h4 className={"text-4xl font-light"}>AMAZON CLONE</h4>
                ...
                <p className={"uppercase py-5 text-gray-300"}>
                    {new Date(experience.dateStarted).toDateString()} -{" "} {experience.isCurrentlyWorkingHere ? "Preset" : new Date(experience.dateEnded).toDateString()}
                </p>
